...
# Print each row of Dictionary 'equity_raw_data'
for x in equity_raw_data:
    print(x, ": $", equity_raw_data[x])
...
# Call Function
growth_rate_percent = growth_rate_funct(equity_raw_data, years_requested, current_year)
