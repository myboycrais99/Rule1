...
for i, ticker in enumerate(tickers):
    ...
    site_cash_flow = r"{}.iedu?report=CF&symbol={}".format(site_root,
                                                           ticker)
    site_trend_analysis = r"{}/trendAnalysis.iedu?symbol={}".format(site_root,
                                                                    ticker)
    ...
    get_stock_data(income_statement.find_all('table'), search_string, file_root,
                   ticker, data_str="income_statement")
    get_stock_data(balance_sheet.find_all('table'), search_string, file_root,
                   ticker, data_str="balance_sheet")
